...
<link rel="stylesheet" href="{{ asset ('font-awesome/css/backend_fonts/font-awesome.css') }}"/>
...
{{-- @yield('content') nece da radi govno --}}
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ route ('admin.admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
